...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('Support', url='https://telegram.me/SHProSearchbot')
            ]]
            ...
            return
        buttons = [[
                    InlineKeyboardButton('🥷 ʜᴇʟᴘ 🥷', url='https://telegram.me/SH_OTT'),
                    InlineKeyboardButton('♻️ ᴜᴘᴅᴀᴛᴇꜱ ♻️', url='https://telegram.me/SH_OTT')
                 ]]
        reply_markup=InlineKeyboardMarkup(buttons)
            ...
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_photo(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           InlineKeyboardButton('ʀᴇᴀᴅ ɢʀᴏᴜᴘ ʀᴜʟᴇs 📌', url='https://telegram.me/Filter5_bot')
                                                                        ]]
                                                 ),
